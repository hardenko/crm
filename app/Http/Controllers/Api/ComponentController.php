...
use App\Resources\ComponentResource;
...
class ComponentController extends BaseApiController
{
    ...
    public function getComponentList(ComponentListRequest $request): JsonResponse
    {
        ...
        return $this->response('successfully_got_component_list', ComponentResource::collection($response));
    }
    ...
    public function addComponent (ComponentRequest $request): JsonResponse
    {
        ...
        return $this->response('component_created_successfully', new ComponentResource($component), status: 201);
    }
}
